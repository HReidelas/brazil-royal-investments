    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        >
          <img
            src={logo}
            alt="Brazil Royal Investments"
            className="w-48 h-48 md:w-64 md:h-64 mx-auto object-contain rounded-full shadow-gold-lg"
          />
        </motion.div>
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-display font-bold text-gradient-gold mb-6 tracking-wider">
            BRAZIL ROYAL
          </h1>
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-display text-gradient-gold mb-8 tracking-[0.3em]">
            INVESTMENTS
          </h2>
        ...
        <motion.p
          ...
          className="text-muted-foreground font-elegant text-xl md:text-2xl max-w-3xl mx-auto mb-12 leading-relaxed italic"
        >
          Unlocking Potential. Maximizing Returns. Delivering Excellence.
        </motion.p>
