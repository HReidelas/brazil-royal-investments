...
const ProductsSection = () => {
  ...
  const featuredProducts = [
    { image: productAngus, title: t.products.angusTitle, subtitle: t.products.angusSub },
    { image: productSteaks, title: t.products.luxSteaksTitle, subtitle: t.products.luxSteaksSub },
    { image: productChicken, title: t.products.chickenTitle, subtitle: t.products.chickenSub },
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
          {featuredProducts.map((p, i) => (
            <motion.div key={p.title} initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: i * 0.1 }} className="group relative overflow-hidden border border-border hover:border-primary transition-all duration-500">
