  ...
  return (
    <section id="partners" className="py-24 md:py-32 bg-secondary">
      <div className="container mx-auto px-6">
        ...
        >
          <p className="text-primary font-body text-sm tracking-[0.4em] uppercase mb-4">Trusted By</p>
          <h2 className="text-3xl md:text-5xl font-display text-gradient-gold mb-6">Our Partners</h2>
            ...
            >
              <div className="w-28 h-28 md:w-36 md:h-36 rounded-full bg-background border border-border flex items-center justify-center p-4 group-hover:border-primary group-hover:shadow-gold transition-all duration-500">
                <img
                  src={p.logo}
                  alt={p.name}
                  className="w-full h-full object-contain rounded-full opacity-80 group-hover:opacity-100 transition-opacity duration-500"
                />
              </div>
