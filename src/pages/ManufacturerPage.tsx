...
import { Factory, Handshake, Globe, CheckCircle, ArrowRight } from "lucide-react";
...
const ManufacturerPage = () => {
  const { t } = useLanguage();
  const p = t.manufacturerPage;

  const benefits = [
    { icon: Globe, title: p.benefit1Title, text: p.benefit1Text },
    { icon: Handshake, title: p.benefit2Title, text: p.benefit2Text },
    { icon: CheckCircle, title: p.benefit3Title, text: p.benefit3Text },
    { icon: ArrowRight, title: p.benefit4Title, text: p.benefit4Text },
  ];
      ...
      <section className="pt-32 pb-24 md:pt-40 md:pb-32">
        <div className="container mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="text-center mb-20">
            <Factory className="w-12 h-12 text-primary mx-auto mb-6" />
